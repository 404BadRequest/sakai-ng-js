...
@Component({
  selector: 'app-detail-reserva-otras',
  templateUrl: './detail-reserva-otras.component.html',
  styleUrl: './detail-reserva-otras.component.scss'
})
export class DetailReservaOtrasComponent implements OnInit{
  reservaId: string;
  reserva: any[] = [];
  reservasInsumos: any[] = [];
